...
static void test_encrypt_ecb_verbose(void)
{
    ...
    AES_ECBEncrypt(cipher_text, sizeof(cipher_text), plain_text, sizeof(plain_text), key, 0);
...
static int test_encrypt_ecb(void)
{
    ...
    AES_ECBEncrypt(result, sizeof(result), in, sizeof(in), key, 0);
...
static int test_decrypt_cbc(void)
{
  ...
  uint8_t buffer[64];
    ...
    AES_CBCDecrypt(buffer, sizeof(buffer), in, sizeof(in), key, iv, 0);
...
static int test_encrypt_cbc(void)
{
    ...
    AES_CBCEncrypt(buffer, sizeof(buffer), in, sizeof(in), key, iv, 0);
...
static int test_xcrypt_ctr(const char* xcrypt)
{
    ...
    AES_CTRXcrypt(result, sizeof(result), in, sizeof(in), key, iv, 0);
  
    printf("CTR %s: ", xcrypt);
  
    if (0 == memcmp((char *) out, (char *) result, 64)) {
        printf("SUCCESS!\n");
    return(0);
    } else {
        printf("FAILURE!\n");
...
static int test_decrypt_ecb(void)
{
    ...
    AES_ECBDecrypt(result, sizeof(result), in, sizeof(in), key, 0);
